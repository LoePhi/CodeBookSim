...
class AND(Gate):
    ...
    def update(self):
        self.out = self.in_a.is_on and self.in_b.is_on
...
class OR(Gate):
    ...
    def update(self):
        self.out = self.in_a.is_on or self.in_b.is_on
